...
public class YoutubeController : Controller
{
    ...
    public async Task<IActionResult> Convert(YoutubeVideo video)
    {
        ...
        try
        {
            ...
            {
                FileName = ytDlpPath,
                Arguments = $"-f \"bestvideo+bestaudio\" --ffmpeg-location \"{ffmpegLocation}\"  --merge-output-format mp4  --cookies-from-browser chrome --extractor-args --progress --print-json \"{video.VideoUrl}\" -o \"{outputPath}\"",
